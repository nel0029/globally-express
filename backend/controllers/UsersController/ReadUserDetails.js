        ...
        const users = await Users.aggregate([
            ...
            },
            {
                $addFields: {
                    ...
                    isFollowedUser: { $cond: [{ $in: [new ObjectId(authorID), "$followers.followerID"] }, true, false] },
                    followID: { $arrayElemAt: ['$followers._id', 0] },
                    isYourFollower: { $cond: [{ $in: [new ObjectId(authorID), "$followings.followingID"] }, true, false] },
